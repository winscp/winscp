...
_bsaes_encrypt8:
 ...
 movdqu xmm8,XMMWORD[rax]
 lea rax,[16+rax]
 movdqu xmm7,XMMWORD[80+r11]
 pxor xmm15,xmm8
 pxor xmm0,xmm8
 pxor xmm1,xmm8
 pxor xmm2,xmm8
...
_bsaes_encrypt8_bitslice:
 movdqu xmm7,XMMWORD[r11]
 movdqu xmm8,XMMWORD[16+r11]
 movdqu xmm9,xmm5
 psrlq xmm5,1
 movdqu xmm10,xmm3
 psrlq xmm3,1
...
$L$enc_sbox:
 ...
 pxor xmm1,xmm9
 movdqu xmm4,xmm8
 movdqu xmm7,XMMWORD[48+r11]
 jnz NEAR $L$enc_loop
 movdqu xmm7,XMMWORD[64+r11]
 jmp NEAR $L$enc_loop
ALIGN 16
$L$enc_done:
 movdqu xmm7,XMMWORD[r11]
...
_bsaes_key_convert:
 ...
 movdqu xmm4,XMMWORD[64+r11]
 pcmpeqd xmm5,xmm5

 movdqu xmm6,XMMWORD[rcx]
 movdqu XMMWORD[rax],xmm7
 lea rax,[16+rax]
 dec r10d
 jmp NEAR $L$key_loop
ALIGN 16
...
DB 102,15,56,0,244
 ...
 pand xmm12,xmm6
 pand xmm13,xmm6
 movdqu XMMWORD[rax],xmm8
 pcmpeqb xmm12,xmm0
 psrlq xmm0,4
 movdqu XMMWORD[16+rax],xmm9
 pcmpeqb xmm13,xmm1
 psrlq xmm1,4
 lea rcx,[16+rcx]
 ...
 pand xmm14,xmm6
 pand xmm15,xmm6
 movdqu XMMWORD[32+rax],xmm10
 pcmpeqb xmm14,xmm2
 psrlq xmm2,4
 movdqu XMMWORD[48+rax],xmm11
 pcmpeqb xmm15,xmm3
 psrlq xmm3,4
 movdqu xmm6,XMMWORD[rcx]
 ...
 pxor xmm13,xmm5
 pxor xmm14,xmm5
 movdqu XMMWORD[64+rax],xmm12
 movdqu XMMWORD[80+rax],xmm13
 movdqu XMMWORD[96+rax],xmm14
 movdqu XMMWORD[112+rax],xmm15
 lea rax,[128+rax]
 dec r10d
 jnz NEAR $L$key_loop
...
$L$cbc_dec_prologue:
 ...
 lea rsp,[((-160))+rsp]
 movups XMMWORD[64+rsp],xmm6
 movups XMMWORD[80+rsp],xmm7
 movups XMMWORD[96+rsp],xmm8
 movups XMMWORD[112+rsp],xmm9
 movups XMMWORD[128+rsp],xmm10
 movups XMMWORD[144+rsp],xmm11
 movups XMMWORD[160+rsp],xmm12
 movups XMMWORD[176+rsp],xmm13
 movups XMMWORD[192+rsp],xmm14
 movups XMMWORD[208+rsp],xmm15
$L$cbc_dec_body:
 mov rbp,rsp
 ...
 movdqu XMMWORD[rax],xmm6
 movdqu XMMWORD[rsp],xmm7
...
$L$cbc_dec_bzero:
 ...
 movups xmm6,XMMWORD[64+rbp]
 movups xmm7,XMMWORD[80+rbp]
 movups xmm8,XMMWORD[96+rbp]
 movups xmm9,XMMWORD[112+rbp]
 movups xmm10,XMMWORD[128+rbp]
 movups xmm11,XMMWORD[144+rbp]
 movups xmm12,XMMWORD[160+rbp]
 movups xmm13,XMMWORD[176+rbp]
 movups xmm14,XMMWORD[192+rbp]
 movups xmm15,XMMWORD[208+rbp]
 lea rax,[160+rax]
$L$cbc_dec_tail:
...
$L$xts_enc_body:
 ...
 pxor xmm14,xmm14
 movdqu xmm12,XMMWORD[$L$xts_magic]
 pcmpgtd xmm14,xmm6
