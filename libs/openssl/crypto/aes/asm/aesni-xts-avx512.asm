...
DB 243,15,30,250
 ...
 vmovdqu XMMWORD[(128 + 0)+rsp],xmm6
 vmovdqu XMMWORD[(128 + 16)+rsp],xmm7
 vmovdqu XMMWORD[(128 + 32)+rsp],xmm8
 vmovdqu XMMWORD[(128 + 48)+rsp],xmm9
 vmovdqu XMMWORD[(128 + 64)+rsp],xmm10
 vmovdqu XMMWORD[(128 + 80)+rsp],xmm11
 vmovdqu XMMWORD[(128 + 96)+rsp],xmm12
 vmovdqu XMMWORD[(128 + 112)+rsp],xmm13
 vmovdqu XMMWORD[(128 + 128)+rsp],xmm14
 vmovdqu XMMWORD[(128 + 144)+rsp],xmm15
 mov r10,0x87
...
$L$_main_loop_run_16_hEgxyDlCngwrfFe:
 ...
 vmovdqu32 zmm9,zmm15
 vmovdqu32 zmm10,zmm16
 vmovdqu32 zmm11,zmm17
 vmovdqu32 zmm12,zmm18
 vmovdqu8 ZMMWORD[rsi],zmm1
...
$L$_ret_hEgxyDlCngwrfFe:
 ...
 vmovdqu xmm6,XMMWORD[((128 + 0))+rsp]
 vmovdqu xmm7,XMMWORD[((128 + 16))+rsp]
 vmovdqu xmm8,XMMWORD[((128 + 32))+rsp]
 vmovdqu xmm9,XMMWORD[((128 + 48))+rsp]


 vmovdqu64 ZMMWORD[128+rsp],zmm0

 vmovdqu xmm10,XMMWORD[((128 + 64))+rsp]
 vmovdqu xmm11,XMMWORD[((128 + 80))+rsp]
 vmovdqu xmm12,XMMWORD[((128 + 96))+rsp]
 vmovdqu xmm13,XMMWORD[((128 + 112))+rsp]


 vmovdqu64 ZMMWORD[(128 + 64)+rsp],zmm0

 vmovdqu xmm14,XMMWORD[((128 + 128))+rsp]
 vmovdqu xmm15,XMMWORD[((128 + 144))+rsp]



 vmovdqu YMMWORD[(128 + 128)+rsp],ymm0
 mov rsp,rbp
 pop rbp
 vzeroupper
...
$L$_steal_cipher_6_amivrujEyduiFoi:
 ...
 mov QWORD[16+rsp],rax
 mov QWORD[24+rsp],rbx
 vmovdqu64 xmm15,xmm14
 vmovdqu xmm14,XMMWORD[16+rsp]
 vpxor xmm1,xmm1,xmm9
 vpxor xmm2,xmm2,xmm10
 vpxor xmm3,xmm3,xmm11
 vpxor xmm4,xmm4,xmm12
...
$L$_steal_cipher_5_amivrujEyduiFoi:
 ...
 mov QWORD[16+rsp],rax
 mov QWORD[24+rsp],rbx
 vmovdqu64 xmm14,xmm13
 vmovdqu xmm13,XMMWORD[16+rsp]
 vpxor xmm1,xmm1,xmm9
 vpxor xmm2,xmm2,xmm10
 vpxor xmm3,xmm3,xmm11
 vpxor xmm4,xmm4,xmm12
...
$L$_steal_cipher_3_amivrujEyduiFoi:
 ...
 mov QWORD[16+rsp],rax
 mov QWORD[24+rsp],rbx
 vmovdqu64 xmm12,xmm11
 vmovdqu xmm11,XMMWORD[16+rsp]
 vpxor xmm1,xmm1,xmm9
 vpxor xmm2,xmm2,xmm10
 vpxor xmm3,xmm3,xmm11
 vmovdqu xmm0,XMMWORD[rcx]
...
$L$_steal_cipher_1_amivrujEyduiFoi:
 ...
 mov QWORD[16+rsp],rax
 mov QWORD[24+rsp],rbx
 vmovdqu64 xmm10,xmm9
 vmovdqu xmm9,XMMWORD[16+rsp]
 vpxor xmm1,xmm1,xmm9
 vmovdqu xmm0,XMMWORD[rcx]
 vpxor xmm1,xmm1,xmm0
 vmovdqu xmm0,XMMWORD[16+rcx]
...
section .rodata align=8 ; WINSCP (rodata)
ALIGN 16
