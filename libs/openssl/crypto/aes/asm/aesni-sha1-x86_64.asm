...
$L$SEH_begin_aesni_cbc_sha1_enc_ssse3:
 ...
 movups XMMWORD[(96+0)+rsp],xmm6
 movups XMMWORD[(96+16)+rsp],xmm7
 movups XMMWORD[(96+32)+rsp],xmm8
 movups XMMWORD[(96+48)+rsp],xmm9
 movups XMMWORD[(96+64)+rsp],xmm10
 movups XMMWORD[(96+80)+rsp],xmm11
 movups XMMWORD[(96+96)+rsp],xmm12
 movups XMMWORD[(96+112)+rsp],xmm13
 movups XMMWORD[(96+128)+rsp],xmm14
 movups XMMWORD[(96+144)+rsp],xmm15
$L$prologue_ssse3:
 mov r12,rdi
 mov r13,rsi
 mov r14,rdx
 ...
 movdqu xmm3,XMMWORD[64+r11]
 movdqu xmm13,XMMWORD[r11]
...
DB 102,15,56,221,209
 ...
 movups xmm6,XMMWORD[((96+0))+rsp]
 movups xmm7,XMMWORD[((96+16))+rsp]
 movups xmm8,XMMWORD[((96+32))+rsp]
 movups xmm9,XMMWORD[((96+48))+rsp]
 movups xmm10,XMMWORD[((96+64))+rsp]
 movups xmm11,XMMWORD[((96+80))+rsp]
 movups xmm12,XMMWORD[((96+96))+rsp]
 movups xmm13,XMMWORD[((96+112))+rsp]
 movups xmm14,XMMWORD[((96+128))+rsp]
 movups xmm15,XMMWORD[((96+144))+rsp]
 lea rsi,[264+rsp]
...
$L$prologue_avx:
 ...
 vmovdqu xmm6,XMMWORD[64+r11]
 vmovdqu xmm10,XMMWORD[r11]
...
$L$prologue_shaext:
 ...
 movdqu xmm7,XMMWORD[((K_XX_XX+80))]
...
DB 102,15,56,221,209
 ...
 movups xmm6,XMMWORD[((-8-160))+rax]
 movups xmm7,XMMWORD[((-8-144))+rax]
 movups xmm8,XMMWORD[((-8-128))+rax]
 movups xmm9,XMMWORD[((-8-112))+rax]
 movups xmm10,XMMWORD[((-8-96))+rax]
 movups xmm11,XMMWORD[((-8-80))+rax]
 movups xmm12,XMMWORD[((-8-64))+rax]
 movups xmm13,XMMWORD[((-8-48))+rax]
 movups xmm14,XMMWORD[((-8-32))+rax]
 movups xmm15,XMMWORD[((-8-16))+rax]
 mov rsp,rax
$L$epilogue_shaext:
 mov rdi,QWORD[8+rsp] ;WIN64 epilogue
 mov rsi,QWORD[16+rsp]
