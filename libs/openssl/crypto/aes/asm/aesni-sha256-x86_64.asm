...
$L$xop_shortcut:
 ...
 movups XMMWORD[128+rsp],xmm6
 movups XMMWORD[144+rsp],xmm7
 movups XMMWORD[160+rsp],xmm8
 movups XMMWORD[176+rsp],xmm9
 movups XMMWORD[192+rsp],xmm10
 movups XMMWORD[208+rsp],xmm11
 movups XMMWORD[224+rsp],xmm12
 movups XMMWORD[240+rsp],xmm13
 movups XMMWORD[256+rsp],xmm14
 movups XMMWORD[272+rsp],xmm15
$L$prologue_xop:
 vzeroall
 ...
 vmovdqu xmm14,XMMWORD[r14*8+r13]
 vmovdqu xmm13,XMMWORD[16+r14*8+r13]
 vmovdqu xmm12,XMMWORD[32+r14*8+r13]
...
DB 143,232,120,194,239,2
 ...
 vzeroall
 movups xmm6,XMMWORD[128+rsp]
 movups xmm7,XMMWORD[144+rsp]
 movups xmm8,XMMWORD[160+rsp]
 movups xmm9,XMMWORD[176+rsp]
 movups xmm10,XMMWORD[192+rsp]
 movups xmm11,XMMWORD[208+rsp]
 movups xmm12,XMMWORD[224+rsp]
 movups xmm13,XMMWORD[240+rsp]
 movups xmm14,XMMWORD[256+rsp]
 movups xmm15,XMMWORD[272+rsp]
...
$L$prologue_avx2:
 ...
 vmovdqu xmm14,XMMWORD[r14*8+r12]
 vmovdqu xmm13,XMMWORD[16+r14*8+r12]
 vmovdqu xmm12,XMMWORD[32+r14*8+r12]
...
$L$done_avx2:
 ...
 vmovdqu XMMWORD[r8],xmm8
 vzeroall
 movups xmm6,XMMWORD[128+rbp]
 movups xmm7,XMMWORD[144+rbp]
 movups xmm8,XMMWORD[160+rbp]
 movups xmm9,XMMWORD[176+rbp]
 movups xmm10,XMMWORD[192+rbp]
 movups xmm11,XMMWORD[208+rbp]
 movups xmm12,XMMWORD[224+rbp]
 movups xmm13,XMMWORD[240+rbp]
 movups xmm14,XMMWORD[256+rbp]
 movups xmm15,XMMWORD[272+rbp]
 mov r15,QWORD[((-48))+rsi]
...
$L$SEH_begin_aesni_cbc_sha256_enc_shaext:
 ...
 mov r10,QWORD[56+rsp]
 lea rsp,[((-168))+rsp]
 movups XMMWORD[(-8-160)+rax],xmm6
 movups XMMWORD[(-8-144)+rax],xmm7
 movups XMMWORD[(-8-128)+rax],xmm8
 movups XMMWORD[(-8-112)+rax],xmm9
 movups XMMWORD[(-8-96)+rax],xmm10
 movups XMMWORD[(-8-80)+rax],xmm11
 movups XMMWORD[(-8-64)+rax],xmm12
 movups XMMWORD[(-8-48)+rax],xmm13
 movups XMMWORD[(-8-32)+rax],xmm14
 movups XMMWORD[(-8-16)+rax],xmm15
$L$prologue_shaext:
 lea rax,[((K256+128))]
 movdqu xmm1,XMMWORD[r9]
 movdqu xmm2,XMMWORD[16+r9]
 movdqu xmm3,XMMWORD[((512-128))+rax]
...
DB 102,65,15,58,15,221,4
 ...
 aesenc xmm6,xmm4
DB 15,56,203,202
 movdqu xmm0,XMMWORD[((256-128))+rax]
 paddd xmm0,xmm10
DB 69,15,56,205,218
DB 69,15,56,204,229
 movups xmm4,XMMWORD[32+rcx]
...
DB 15,56,203,202
 ...
 movups xmm5,XMMWORD[((-80))+rcx]
 aesenc xmm6,xmm4
 movdqu xmm0,XMMWORD[((288-128))+rax]
 paddd xmm0,xmm11
DB 69,15,56,205,227
DB 69,15,56,204,234
 movups xmm4,XMMWORD[((-64))+rcx]
...
DB 102,65,15,58,15,219,4
 ...
 aesenc xmm6,xmm4
DB 15,56,203,202
 movdqu xmm0,XMMWORD[((320-128))+rax]
 paddd xmm0,xmm12
DB 69,15,56,205,236
DB 69,15,56,204,211
 movups xmm4,XMMWORD[((-32))+rcx]
...
DB 102,65,15,58,15,220,4
 ...
 aesenc xmm6,xmm4
DB 15,56,203,202
 movdqu xmm0,XMMWORD[((352-128))+rax]
 paddd xmm0,xmm13
DB 69,15,56,205,213
DB 69,15,56,204,220
 movups xmm4,XMMWORD[rcx]
...
DB 102,65,15,58,15,221,4
 ...
 aesenc xmm6,xmm4
DB 15,56,203,202
 movdqu xmm0,XMMWORD[((384-128))+rax]
 paddd xmm0,xmm10
DB 69,15,56,205,218
DB 69,15,56,204,229
 movups xmm4,XMMWORD[32+rcx]
...
DB 102,65,15,58,15,218,4
 ...
 aesenc xmm6,xmm4
DB 15,56,203,202
 movdqu xmm0,XMMWORD[((416-128))+rax]
 paddd xmm0,xmm11
DB 69,15,56,205,227
DB 69,15,56,204,234
 cmp r11d,11
...
DB 15,56,203,202
 ...
 movdqu xmm0,XMMWORD[((448-128))+rax]
 paddd xmm0,xmm12
DB 69,15,56,205,236
 movdqu xmm3,xmm7
 movups xmm5,XMMWORD[((-48))+rcx]
...
DB 15,56,203,202
 ...
 movdqu xmm0,XMMWORD[((480-128))+rax]
 paddd xmm0,xmm13
 movups xmm5,XMMWORD[((-16))+rcx]
 aesenc xmm6,xmm4
 movups xmm4,XMMWORD[rcx]
