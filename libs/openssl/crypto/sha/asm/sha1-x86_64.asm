...
_shaext_shortcut:
 ...
 lea rsp,[((-72))+rsp]
 movups XMMWORD[(-8-64)+rax],xmm6
 movups XMMWORD[(-8-48)+rax],xmm7
 movups XMMWORD[(-8-32)+rax],xmm8
 movups XMMWORD[(-8-16)+rax],xmm9
$L$prologue_shaext:
 movdqu xmm0,XMMWORD[rdi]
 movd xmm1,DWORD[16+rdi]
 movdqu xmm3,XMMWORD[((K_XX_XX+160))]
...
DB 102,15,56,0,251
 ...
 movups xmm6,XMMWORD[((-8-64))+rax]
 movups xmm7,XMMWORD[((-8-48))+rax]
 movups xmm8,XMMWORD[((-8-32))+rax]
 movups xmm9,XMMWORD[((-8-16))+rax]
 mov rsp,rax
$L$epilogue_shaext:
 mov rdi,QWORD[8+rsp] ;WIN64 epilogue
 mov rsi,QWORD[16+rsp]
...
_ssse3_shortcut:
 ...
 lea rsp,[((-160))+rsp]
 movups XMMWORD[(-40-96)+r11],xmm6
 movups XMMWORD[(-40-80)+r11],xmm7
 movups XMMWORD[(-40-64)+r11],xmm8
 movups XMMWORD[(-40-48)+r11],xmm9
 movups XMMWORD[(-40-32)+r11],xmm10
 movups XMMWORD[(-40-16)+r11],xmm11
$L$prologue_ssse3:
 and rsp,-64
 mov r8,rdi
 mov r9,rsi
 ...
 movdqu xmm6,XMMWORD[64+r14]
 movdqu xmm9,XMMWORD[((-64))+r14]
...
$L$done_ssse3:
 ...
 mov DWORD[12+r8],edx
 mov DWORD[16+r8],ebp
 movups xmm6,XMMWORD[((-40-96))+r11]
 movups xmm7,XMMWORD[((-40-80))+r11]
 movups xmm8,XMMWORD[((-40-64))+r11]
 movups xmm9,XMMWORD[((-40-48))+r11]
 movups xmm10,XMMWORD[((-40-32))+r11]
 movups xmm11,XMMWORD[((-40-16))+r11]
...
_avx_shortcut:
 ...
 lea rsp,[((-160))+rsp]
 vzeroupper
 vmovups XMMWORD[(-40-96)+r11],xmm6
 vmovups XMMWORD[(-40-80)+r11],xmm7
 vmovups XMMWORD[(-40-64)+r11],xmm8
 vmovups XMMWORD[(-40-48)+r11],xmm9
 vmovups XMMWORD[(-40-32)+r11],xmm10
 vmovups XMMWORD[(-40-16)+r11],xmm11
$L$prologue_avx:
 and rsp,-64
 mov r8,rdi
 mov r9,rsi
 ...
 vmovdqu xmm6,XMMWORD[64+r14]
 vmovdqu xmm11,XMMWORD[((-64))+r14]
