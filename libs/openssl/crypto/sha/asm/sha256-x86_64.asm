...
_shaext_shortcut:
 ...
 lea rsp,[((-88))+rsp]
 movups XMMWORD[(-8-80)+rax],xmm6
 movups XMMWORD[(-8-64)+rax],xmm7
 movups XMMWORD[(-8-48)+rax],xmm8
 movups XMMWORD[(-8-32)+rax],xmm9
 movups XMMWORD[(-8-16)+rax],xmm10
$L$prologue_shaext:
 lea rcx,[((K256+128))]
 movdqu xmm1,XMMWORD[rdi]
 movdqu xmm2,XMMWORD[16+rdi]
 movdqu xmm7,XMMWORD[((512-128))+rcx]
...
DB 15,56,203,202
 ...
 movdqu xmm0,XMMWORD[((32-128))+rcx]
 paddd xmm0,xmm4
DB 102,15,56,0,239
DB 15,56,203,209
 pshufd xmm0,xmm0,0x0e
...
DB 15,56,203,202
 ...
 movdqu xmm0,XMMWORD[((64-128))+rcx]
 paddd xmm0,xmm5
DB 102,15,56,0,247
DB 15,56,203,209
 pshufd xmm0,xmm0,0x0e
...
DB 15,56,203,202
 ...
 movdqu xmm0,XMMWORD[((96-128))+rcx]
 paddd xmm0,xmm6
DB 15,56,205,222
DB 15,56,203,209
 pshufd xmm0,xmm0,0x0e
...
DB 15,56,204,238
DB 15,56,203,202
 movdqu xmm0,XMMWORD[((128-128))+rcx]
 paddd xmm0,xmm3
DB 15,56,205,227
DB 15,56,203,209
 pshufd xmm0,xmm0,0x0e
...
DB 15,56,204,243
DB 15,56,203,202
 movdqu xmm0,XMMWORD[((160-128))+rcx]
 paddd xmm0,xmm4
DB 15,56,205,236
DB 15,56,203,209
 pshufd xmm0,xmm0,0x0e
...
DB 15,56,204,220
DB 15,56,203,202
 movdqu xmm0,XMMWORD[((192-128))+rcx]
 paddd xmm0,xmm5
DB 15,56,205,245
DB 15,56,203,209
 pshufd xmm0,xmm0,0x0e
...
DB 15,56,204,229
DB 15,56,203,202
 movdqu xmm0,XMMWORD[((224-128))+rcx]
 paddd xmm0,xmm6
DB 15,56,205,222
DB 15,56,203,209
 pshufd xmm0,xmm0,0x0e
...
DB 15,56,204,238
DB 15,56,203,202
 movdqu xmm0,XMMWORD[((256-128))+rcx]
 paddd xmm0,xmm3
DB 15,56,205,227
DB 15,56,203,209
 pshufd xmm0,xmm0,0x0e
...
DB 15,56,204,243
DB 15,56,203,202
 movdqu xmm0,XMMWORD[((288-128))+rcx]
 paddd xmm0,xmm4
DB 15,56,205,236
DB 15,56,203,209
 pshufd xmm0,xmm0,0x0e
...
DB 15,56,204,220
DB 15,56,203,202
 movdqu xmm0,XMMWORD[((320-128))+rcx]
 paddd xmm0,xmm5
DB 15,56,205,245
DB 15,56,203,209
 pshufd xmm0,xmm0,0x0e
...
DB 15,56,204,229
DB 15,56,203,202
 movdqu xmm0,XMMWORD[((352-128))+rcx]
 paddd xmm0,xmm6
DB 15,56,205,222
DB 15,56,203,209
 pshufd xmm0,xmm0,0x0e
...
DB 15,56,204,238
DB 15,56,203,202
 movdqu xmm0,XMMWORD[((384-128))+rcx]
 paddd xmm0,xmm3
DB 15,56,205,227
DB 15,56,203,209
 pshufd xmm0,xmm0,0x0e
...
DB 15,56,204,243
DB 15,56,203,202
 movdqu xmm0,XMMWORD[((416-128))+rcx]
 paddd xmm0,xmm4
DB 15,56,205,236
DB 15,56,203,209
 pshufd xmm0,xmm0,0x0e
...
DB 15,56,203,202
 ...
 movdqu xmm0,XMMWORD[((448-128))+rcx]
 paddd xmm0,xmm5
DB 15,56,203,209
 pshufd xmm0,xmm0,0x0e
DB 15,56,205,245
...
DB 15,56,203,202
 ...
 movdqu xmm0,XMMWORD[((480-128))+rcx]
 paddd xmm0,xmm6
 nop
DB 15,56,203,209
 pshufd xmm0,xmm0,0x0e
...
DB 102,15,58,15,215,8
 ...
 movups xmm6,XMMWORD[((-8-80))+rax]
 movups xmm7,XMMWORD[((-8-64))+rax]
 movups xmm8,XMMWORD[((-8-48))+rax]
 movups xmm9,XMMWORD[((-8-32))+rax]
 movups xmm10,XMMWORD[((-8-16))+rax]
 mov rsp,rax
$L$epilogue_shaext:
 mov rdi,QWORD[8+rsp] ;WIN64 epilogue
 mov rsi,QWORD[16+rsp]
...
$L$ssse3_shortcut:
 ...
 movups XMMWORD[(64+32)+rsp],xmm6
 movups XMMWORD[(64+48)+rsp],xmm7
 movups XMMWORD[(64+64)+rsp],xmm8
 movups XMMWORD[(64+80)+rsp],xmm9
$L$prologue_ssse3:
...
DB 102,15,56,0,207
 ...
 movdqu xmm5,XMMWORD[32+rbp]
DB 102,15,56,0,215
 paddd xmm4,xmm0
 movdqu xmm6,XMMWORD[64+rbp]
DB 102,15,56,0,223
 movdqu xmm7,XMMWORD[96+rbp]
 paddd xmm5,xmm1
 paddd xmm6,xmm2
 paddd xmm7,xmm3
...
DB 102,15,58,15,249,4
 ...
 movups xmm6,XMMWORD[((64+32))+rsp]
 movups xmm7,XMMWORD[((64+48))+rsp]
 movups xmm8,XMMWORD[((64+64))+rsp]
 movups xmm9,XMMWORD[((64+80))+rsp]
 mov r15,QWORD[((-48))+rsi]
...
$L$prologue_avx:
 ...
 mov r10d,DWORD[24+rdi]
 mov r11d,DWORD[28+rdi]
 vmovdqu xmm8,XMMWORD[((K256+512+32))]
 vmovdqu xmm9,XMMWORD[((K256+512+64))]
 jmp NEAR $L$loop_avx
ALIGN 16
$L$loop_avx:
 vmovdqu xmm7,XMMWORD[((K256+512))]
...
$L$prologue_avx2:
 ...
 mov r10d,DWORD[24+rdi]
 mov r11d,DWORD[28+rdi]
 vmovdqu ymm8,YMMWORD[((K256+512+32))]
 vmovdqu ymm9,YMMWORD[((K256+512+64))]
 jmp NEAR $L$oop_avx2
ALIGN 16
$L$oop_avx2:
 vmovdqu ymm7,YMMWORD[((K256+512))]
...
$L$done_avx2:
 ...
 vzeroupper
 movups xmm6,XMMWORD[((64+32))+rbp]
 movups xmm7,XMMWORD[((64+48))+rbp]
 movups xmm8,XMMWORD[((64+64))+rbp]
 movups xmm9,XMMWORD[((64+80))+rbp]
 mov r15,QWORD[((-48))+rsi]
