...
$L$xop_shortcut:
 ...
 movups XMMWORD[(128+32)+rsp],xmm6
 movups XMMWORD[(128+48)+rsp],xmm7
 movups XMMWORD[(128+64)+rsp],xmm8
 movups XMMWORD[(128+80)+rsp],xmm9
 movups XMMWORD[(128+96)+rsp],xmm10
 movups XMMWORD[(128+112)+rsp],xmm11
$L$prologue_xop:
...
ALIGN 16
$L$loop_xop:
 vmovdqu xmm11,XMMWORD[((K512+1280))]
 ...
 vmovdqu XMMWORD[32+rsp],xmm10
 vpaddq xmm10,xmm6,XMMWORD[64+rbp]
 vmovdqu XMMWORD[48+rsp],xmm11
...
DB 143,72,120,195,203,42
 ...
 vzeroupper
 movups xmm6,XMMWORD[((128+32))+rsp]
 movups xmm7,XMMWORD[((128+48))+rsp]
 movups xmm8,XMMWORD[((128+64))+rsp]
 movups xmm9,XMMWORD[((128+80))+rsp]
 movups xmm10,XMMWORD[((128+96))+rsp]
 movups xmm11,XMMWORD[((128+112))+rsp]
 mov r15,QWORD[((-48))+rsi]
...
$L$oop_avx2:
 ...
 vmovdqu ymm10,YMMWORD[1152+rbp]
...
$L$done_avx2:
 ...
 vzeroupper
 movups xmm6,XMMWORD[((128+32))+rbp]
 movups xmm7,XMMWORD[((128+48))+rbp]
 movups xmm8,XMMWORD[((128+64))+rbp]
 movups xmm9,XMMWORD[((128+80))+rbp]
 movups xmm10,XMMWORD[((128+96))+rbp]
 movups xmm11,XMMWORD[((128+112))+rbp]
 mov r15,QWORD[((-48))+rsi]
