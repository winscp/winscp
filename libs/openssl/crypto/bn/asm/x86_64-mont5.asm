...
DB 0x67
 ...
 paddd xmm2,xmm1
 pcmpeqd xmm1,xmm5
 movdqu XMMWORD[112+r10],xmm0
 movdqu xmm0,xmm4

 paddd xmm3,xmm2
 pcmpeqd xmm2,xmm5
 movdqu XMMWORD[128+r10],xmm1
 movdqu xmm1,xmm4

 paddd xmm0,xmm3
 pcmpeqd xmm3,xmm5
 movdqu XMMWORD[144+r10],xmm2
 movdqu xmm2,xmm4

 paddd xmm1,xmm0
 pcmpeqd xmm0,xmm5
 movdqu XMMWORD[160+r10],xmm3
 movdqu xmm3,xmm4
 paddd xmm2,xmm1
 pcmpeqd xmm1,xmm5
 movdqu XMMWORD[176+r10],xmm0
 movdqu xmm0,xmm4

 paddd xmm3,xmm2
 pcmpeqd xmm2,xmm5
 movdqu XMMWORD[192+r10],xmm1
 movdqu xmm1,xmm4

 paddd xmm0,xmm3
 pcmpeqd xmm3,xmm5
 movdqu XMMWORD[208+r10],xmm2
 movdqu xmm2,xmm4

 paddd xmm1,xmm0
 pcmpeqd xmm0,xmm5
 movdqu XMMWORD[224+r10],xmm3
 movdqu xmm3,xmm4
 paddd xmm2,xmm1
 pcmpeqd xmm1,xmm5
 movdqu XMMWORD[240+r10],xmm0
 movdqu xmm0,xmm4

 paddd xmm3,xmm2
 pcmpeqd xmm2,xmm5
 movdqu XMMWORD[256+r10],xmm1
 movdqu xmm1,xmm4

 paddd xmm0,xmm3
 pcmpeqd xmm3,xmm5
 movdqu XMMWORD[272+r10],xmm2
 movdqu xmm2,xmm4

 paddd xmm1,xmm0
 pcmpeqd xmm0,xmm5
 movdqu XMMWORD[288+r10],xmm3
 movdqu xmm3,xmm4
 paddd xmm2,xmm1
 pcmpeqd xmm1,xmm5
 movdqu XMMWORD[304+r10],xmm0

 paddd xmm3,xmm2
DB 0x67
 pcmpeqd xmm2,xmm5
 movdqu XMMWORD[320+r10],xmm1

 pcmpeqd xmm3,xmm5
 movdqu XMMWORD[336+r10],xmm2
 pand xmm0,XMMWORD[64+r12]

 pand xmm1,XMMWORD[80+r12]
 pand xmm2,XMMWORD[96+r12]
 movdqu XMMWORD[352+r10],xmm3
 pand xmm3,XMMWORD[112+r12]
 por xmm0,xmm2
 por xmm1,xmm3
 movdqu xmm4,XMMWORD[((-128))+r12]
 movdqu xmm5,XMMWORD[((-112))+r12]
 movdqu xmm2,XMMWORD[((-96))+r12]
 pand xmm4,XMMWORD[112+r10]
 movdqu xmm3,XMMWORD[((-80))+r12]
 ...
 por xmm0,xmm2
 por xmm1,xmm3
 movdqu xmm4,XMMWORD[((-64))+r12]
 movdqu xmm5,XMMWORD[((-48))+r12]
 movdqu xmm2,XMMWORD[((-32))+r12]
 pand xmm4,XMMWORD[176+r10]
 movdqu xmm3,XMMWORD[((-16))+r12]
 ...
 por xmm0,xmm2
 por xmm1,xmm3
 movdqu xmm4,XMMWORD[r12]
 movdqu xmm5,XMMWORD[16+r12]
 movdqu xmm2,XMMWORD[32+r12]
 pand xmm4,XMMWORD[240+r10]
 movdqu xmm3,XMMWORD[48+r12]
...
$L$outer:
 ...
 pxor xmm4,xmm4
 pxor xmm5,xmm5
 movdqu xmm0,XMMWORD[((-128))+r12]
 movdqu xmm1,XMMWORD[((-112))+r12]
 movdqu xmm2,XMMWORD[((-96))+r12]
 movdqu xmm3,XMMWORD[((-80))+r12]
 ...
 por xmm4,xmm2
 por xmm5,xmm3
 movdqu xmm0,XMMWORD[((-64))+r12]
 movdqu xmm1,XMMWORD[((-48))+r12]
 movdqu xmm2,XMMWORD[((-32))+r12]
 movdqu xmm3,XMMWORD[((-16))+r12]
 ...
 por xmm5,xmm3
 movdqu xmm0,XMMWORD[64+r12]
 movdqu xmm1,XMMWORD[80+r12]
 movdqu xmm2,XMMWORD[96+r12]
 movdqu xmm3,XMMWORD[112+r12]
 pand xmm0,XMMWORD[64+rdx]
...
DB 0x67
 ...
 por xmm0,xmm2
 por xmm1,xmm3
 movdqu xmm4,XMMWORD[((-128))+rdi]
 movdqu xmm5,XMMWORD[((-112))+rdi]
 movdqu xmm2,XMMWORD[((-96))+rdi]
 pand xmm4,XMMWORD[112+r10]
 movdqu xmm3,XMMWORD[((-80))+rdi]
 pand xmm5,XMMWORD[128+r10]
 por xmm0,xmm4
 pand xmm2,XMMWORD[144+r10]
 por xmm1,xmm5
 ...
 por xmm0,xmm2
 por xmm1,xmm3
 movdqu xmm4,XMMWORD[((-64))+rdi]
 movdqu xmm5,XMMWORD[((-48))+rdi]
 movdqu xmm2,XMMWORD[((-32))+rdi]
 pand xmm4,XMMWORD[176+r10]
...
DB 0x48,0x81,0xec,0x08,0x01,0x00,0x00
 ...
 paddd xmm2,xmm1
 pcmpeqd xmm1,xmm5
 movdqu XMMWORD[(-128)+rax],xmm0
 movdqu xmm0,xmm4

 paddd xmm3,xmm2
 pcmpeqd xmm2,xmm5
 movdqu XMMWORD[(-112)+rax],xmm1
 movdqu xmm1,xmm4

 paddd xmm0,xmm3
 pcmpeqd xmm3,xmm5
 movdqu XMMWORD[(-96)+rax],xmm2
 movdqu xmm2,xmm4
 paddd xmm1,xmm0
 pcmpeqd xmm0,xmm5
 movdqu XMMWORD[(-80)+rax],xmm3
 movdqu xmm3,xmm4

 paddd xmm2,xmm1
 pcmpeqd xmm1,xmm5
 movdqu XMMWORD[(-64)+rax],xmm0
 movdqu xmm0,xmm4

 paddd xmm3,xmm2
 pcmpeqd xmm2,xmm5
 movdqu XMMWORD[(-48)+rax],xmm1
 movdqu xmm1,xmm4

 paddd xmm0,xmm3
 pcmpeqd xmm3,xmm5
 movdqu XMMWORD[(-32)+rax],xmm2
 movdqu xmm2,xmm4
 paddd xmm1,xmm0
 pcmpeqd xmm0,xmm5
 movdqu XMMWORD[(-16)+rax],xmm3
 movdqu xmm3,xmm4
...
$L$gather:
 pxor xmm4,xmm4
 pxor xmm5,xmm5
 movdqu xmm0,XMMWORD[((-128))+r11]
 movdqu xmm1,XMMWORD[((-112))+r11]
 movdqu xmm2,XMMWORD[((-96))+r11]
 pand xmm0,XMMWORD[((-128))+rax]
 movdqu xmm3,XMMWORD[((-80))+r11]
 ...
 por xmm4,xmm2
 por xmm5,xmm3
 movdqu xmm0,XMMWORD[((-64))+r11]
 movdqu xmm1,XMMWORD[((-48))+r11]
 movdqu xmm2,XMMWORD[((-32))+r11]
 pand xmm0,XMMWORD[((-64))+rax]
 movdqu xmm3,XMMWORD[((-16))+r11]
 ...
 movdqu xmm1,XMMWORD[16+r11]
 movdqu xmm2,XMMWORD[32+r11]
 pand xmm0,XMMWORD[rax]
 movdqu xmm3,XMMWORD[48+r11]
