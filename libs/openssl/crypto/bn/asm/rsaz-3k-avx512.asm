...
DB 243,15,30,250
 ...
 lea rsp,[((-168))+rsp]
 vmovdqu64 XMMWORD[rsp],xmm6
 vmovdqu64 XMMWORD[16+rsp],xmm7
 vmovdqu64 XMMWORD[32+rsp],xmm8
 vmovdqu64 XMMWORD[48+rsp],xmm9
 vmovdqu64 XMMWORD[64+rsp],xmm10
 vmovdqu64 XMMWORD[80+rsp],xmm11
 vmovdqu64 XMMWORD[96+rsp],xmm12
 vmovdqu64 XMMWORD[112+rsp],xmm13
 vmovdqu64 XMMWORD[128+rsp],xmm14
 vmovdqu64 XMMWORD[144+rsp],xmm15
...
$L$loop7:
 ...
 vmovdqu64 xmm6,XMMWORD[rax]
 vmovdqu64 xmm7,XMMWORD[16+rax]
 vmovdqu64 xmm8,XMMWORD[32+rax]
 vmovdqu64 xmm9,XMMWORD[48+rax]
 vmovdqu64 xmm10,XMMWORD[64+rax]
 vmovdqu64 xmm11,XMMWORD[80+rax]
 vmovdqu64 xmm12,XMMWORD[96+rax]
 vmovdqu64 xmm13,XMMWORD[112+rax]
 vmovdqu64 xmm14,XMMWORD[128+rax]
 vmovdqu64 xmm15,XMMWORD[144+rax]
 lea rax,[168+rsp]
 mov r15,QWORD[rax]
...
$L$ossl_rsaz_amm52x30_x2_ifma256_body:
 ...
 vmovdqu64 ymm11,ymm0
 vmovdqu64 ymm12,ymm0
 vmovdqu64 ymm13,ymm0
 vmovdqu64 ymm14,ymm0
 vmovdqu64 ymm15,ymm0
 vmovdqu64 ymm16,ymm0
 vmovdqu64 ymm17,ymm0
 vmovdqu64 ymm18,ymm0
...
DB 243,15,30,250
 vmovdqu64 ymm30,YMMWORD[$L$ones]
 ...
 vmovdqu64 ymm17,ymm0
 vmovdqu64 ymm18,ymm0
 vmovdqu64 ymm19,ymm0
 vmovdqu64 ymm20,ymm0
 vmovdqu64 ymm21,ymm0
 vmovdqu64 ymm22,ymm0
 vmovdqu64 ymm23,ymm0
 vmovdqu64 ymm24,ymm0
 vmovdqu64 ymm25,ymm0
