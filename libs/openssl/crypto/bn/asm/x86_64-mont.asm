...
ALIGN 16
$L$copy4x:
 movdqu xmm1,XMMWORD[rax*1+rsp]
 movdqu xmm2,XMMWORD[rax*1+rdi]
 pand xmm1,xmm4
 pand xmm2,xmm5
 movdqu xmm3,XMMWORD[16+rax*1+rsp]
 movdqu XMMWORD[rax*1+rsp],xmm0
 por xmm1,xmm2
 movdqu xmm2,XMMWORD[16+rax*1+rdi]
 movdqu XMMWORD[rax*1+rdi],xmm1
 pand xmm3,xmm4
 pand xmm2,xmm5
 movdqu XMMWORD[16+rax*1+rsp],xmm0
 por xmm3,xmm2
...
$L$sqr8x_cond_copy:
 ...
 movdqu xmm3,XMMWORD[16+rbx]
 lea rbx,[32+rbx]
 movdqu xmm4,XMMWORD[rdi]
 movdqu xmm5,XMMWORD[16+rdi]
 lea rdi,[32+rdi]
 movdqu XMMWORD[(-32)+rbx],xmm0
 movdqu XMMWORD[(-16)+rbx],xmm0
 movdqu XMMWORD[(-32)+rdx*1+rbx],xmm0
 movdqu XMMWORD[(-16)+rdx*1+rbx],xmm0
 pcmpeqd xmm0,xmm1
 pand xmm2,xmm1
 pand xmm3,xmm1
 pand xmm4,xmm0
