...
DB 243,15,30,250
 ...
 lea rsp,[((-168))+rsp]
 vmovupd XMMWORD[rsp],xmm6
 vmovupd XMMWORD[16+rsp],xmm7
 vmovupd XMMWORD[32+rsp],xmm8
 vmovupd XMMWORD[48+rsp],xmm9
 vmovupd XMMWORD[64+rsp],xmm10
 vmovupd XMMWORD[80+rsp],xmm11
 vmovupd XMMWORD[96+rsp],xmm12
 vmovupd XMMWORD[112+rsp],xmm13
 vmovupd XMMWORD[128+rsp],xmm14
 vmovupd XMMWORD[144+rsp],xmm15
...
{vex} vpmadd52huq ymm12,ymm2,YMMWORD[288+rcx]
 ...
 shl r14,5
 vmovupd ymm14,YMMWORD[r14*1+r8]
 ...
 shl r13,5
 vmovupd ymm14,YMMWORD[r13*1+r8]
 ...
 shl r12,5
 vmovupd ymm14,YMMWORD[r12*1+r8]
 ...
 shl r11,5
 vmovupd ymm14,YMMWORD[r11*1+r8]
 ...
 shl r10,5
 vmovupd ymm14,YMMWORD[r10*1+r8]
 ...
 vmovupd xmm6,XMMWORD[rax]
 vmovupd xmm7,XMMWORD[16+rax]
 vmovupd xmm8,XMMWORD[32+rax]
 vmovupd xmm9,XMMWORD[48+rax]
 vmovupd xmm10,XMMWORD[64+rax]
 vmovupd xmm11,XMMWORD[80+rax]
 vmovupd xmm12,XMMWORD[96+rax]
 vmovupd xmm13,XMMWORD[112+rax]
 vmovupd xmm14,XMMWORD[128+rax]
 vmovupd xmm15,XMMWORD[144+rax]
 lea rax,[168+rsp]
 mov r15,QWORD[rax]
...
section .rodata align=32 ; WINSCP (rodata)
ALIGN 32
$L$mask52x4:
 DQ 0xfffffffffffff
 DQ 0xfffffffffffff
...
$L$loop_320:
 ...
 vzeroupper
 vmovupd xmm6,XMMWORD[rsp]
 vmovupd xmm7,XMMWORD[16+rsp]
 vmovupd xmm8,XMMWORD[32+rsp]
 vmovupd xmm9,XMMWORD[48+rsp]
 vmovupd xmm10,XMMWORD[64+rsp]
 vmovupd xmm11,XMMWORD[80+rsp]
 vmovupd xmm12,XMMWORD[96+rsp]
 vmovupd xmm13,XMMWORD[112+rsp]
 vmovupd xmm14,XMMWORD[128+rsp]
 vmovupd xmm15,XMMWORD[144+rsp]
 lea rsp,[168+rsp]
 pop rdi
 pop rsi
