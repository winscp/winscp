...
$L$SEH_begin_rsaz_1024_sqr_avx2:
 ...
 vzeroupper
 lea rsp,[((-168))+rsp]
 vmovups XMMWORD[(-216)+rax],xmm6
 vmovups XMMWORD[(-200)+rax],xmm7
 vmovups XMMWORD[(-184)+rax],xmm8
 vmovups XMMWORD[(-168)+rax],xmm9
 vmovups XMMWORD[(-152)+rax],xmm10
 vmovups XMMWORD[(-136)+rax],xmm11
 vmovups XMMWORD[(-120)+rax],xmm12
 vmovups XMMWORD[(-104)+rax],xmm13
 vmovups XMMWORD[(-88)+rax],xmm14
 vmovups XMMWORD[(-72)+rax],xmm15
$L$sqr_1024_body:
 mov rbp,rax
...
$L$OOP_GRANDE_SQR_1024:
 ...
 vmovdqu YMMWORD[(0-128)+r9],ymm1
 vpaddq ymm3,ymm3,ymm3
 vmovdqu YMMWORD[(32-128)+r9],ymm2
 vpaddq ymm4,ymm4,ymm4
 vmovdqu YMMWORD[(64-128)+r9],ymm3
 vpaddq ymm5,ymm5,ymm5
 vmovdqu YMMWORD[(96-128)+r9],ymm4
 vpaddq ymm6,ymm6,ymm6
 vmovdqu YMMWORD[(128-128)+r9],ymm5
 vpaddq ymm7,ymm7,ymm7
 vmovdqu YMMWORD[(160-128)+r9],ymm6
 vpaddq ymm8,ymm8,ymm8
 vmovdqu YMMWORD[(192-128)+r9],ymm7
 vpxor ymm9,ymm9,ymm9
 vmovdqu YMMWORD[(224-128)+r9],ymm8
...
DB 0xc5,0x78,0x29,0x78,0x70
 ...
 vmovd xmm4,r8d
 vmovdqu ymm0,YMMWORD[r10]
 vmovdqu ymm1,YMMWORD[32+r10]
 vmovdqu ymm5,YMMWORD[64+r10]
 ...
 vmovdqu YMMWORD[(0+128)+rax],ymm0
 vpaddd ymm0,ymm2,ymm5
 vpcmpeqd ymm2,ymm2,ymm4
 vmovdqu YMMWORD[(32+128)+rax],ymm1
 vpaddd ymm1,ymm3,ymm5
 vpcmpeqd ymm3,ymm3,ymm4
 vmovdqu YMMWORD[(64+128)+rax],ymm2
 vpaddd ymm2,ymm0,ymm5
 vpcmpeqd ymm0,ymm0,ymm4
 vmovdqu YMMWORD[(96+128)+rax],ymm3
 vpaddd ymm3,ymm1,ymm5
 vpcmpeqd ymm1,ymm1,ymm4
 vmovdqu YMMWORD[(128+128)+rax],ymm0
 vpaddd ymm8,ymm2,ymm5
 vpcmpeqd ymm2,ymm2,ymm4
 vmovdqu YMMWORD[(160+128)+rax],ymm1
 vpaddd ymm9,ymm3,ymm5
 vpcmpeqd ymm3,ymm3,ymm4
 vmovdqu YMMWORD[(192+128)+rax],ymm2
 vpaddd ymm10,ymm8,ymm5
 vpcmpeqd ymm8,ymm8,ymm4
 vmovdqu YMMWORD[(224+128)+rax],ymm3
 ...
 vmovdqu ymm7,YMMWORD[((-32))+r10]
 lea rdx,[128+rdx]
 mov r8d,9

$L$oop_gather_1024:
 vmovdqu ymm0,YMMWORD[((0-128))+rdx]
 vmovdqu ymm1,YMMWORD[((32-128))+rdx]
 vmovdqu ymm2,YMMWORD[((64-128))+rdx]
 vmovdqu ymm3,YMMWORD[((96-128))+rdx]
 ...
 vmovdqu ymm0,YMMWORD[((128-128))+rdx]
 vmovdqu ymm1,YMMWORD[((160-128))+rdx]
 vpor ymm5,ymm3,ymm2
 vmovdqu ymm2,YMMWORD[((192-128))+rdx]
 vmovdqu ymm3,YMMWORD[((224-128))+rdx]
