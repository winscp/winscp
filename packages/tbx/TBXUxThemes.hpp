...
// (DO NOT EDIT: machine generated header) 'TBXUxThemes.pas' rev: 6.00

#ifndef TBXUxThemesHPP
#define TBXUxThemesHPP
...
extern PACKAGE HRESULT __stdcall (*DrawThemeText)(unsigned hTheme, HDC hdc, int iPartId, int iStateId, wchar_t * pszText, int iCharCount, unsigned dwTextFlags, unsigned dwTextFlags2, const Types::TRect &pRect);
extern PACKAGE HRESULT __stdcall (*GetThemeBackgroundContentRect)(unsigned hTheme, HDC hdc, int iPartId, int iStateId, const Types::TRect &pBoundingRect, Types::PRect pContentRect);
extern PACKAGE HRESULT __stdcall (*GetThemeBackgroundExtent)(unsigned hTheme, HDC hdc, int iPartId, int iStateId, const Types::TRect &pContentRect, Types::TRect &pExtentRect);
extern PACKAGE HRESULT __stdcall (*GetThemePartSize)(unsigned hTheme, HDC hdc, int iPartId, int iStateId, Types::PRect prc, THEMESIZE eSize, tagSIZE &psz);
extern PACKAGE HRESULT __stdcall (*GetThemeTextExtent)(unsigned hTheme, HDC hdc, int iPartId, int iStateId, wchar_t * pszText, int iCharCount, unsigned dwTextFlags, Types::PRect pBoundingRect, Types::TRect &pExtentRect);
extern PACKAGE HRESULT __stdcall (*GetThemeTextMetrics)(unsigned hTheme, HDC hdc, int iPartId, int iStateId, tagTEXTMETRICA &ptm);
extern PACKAGE HRESULT __stdcall (*GetThemeBackgroundRegion)(unsigned hTheme, HDC hdc, int iPartId, int iStateId, const Types::TRect &pRect, HRGN &pRegion);
extern PACKAGE HRESULT __stdcall (*HitTestThemeBackground)(unsigned hTheme, HDC hdc, int iPartId, int iStateId, unsigned dwOptions, const Types::TRect &pRect, HRGN hrgn, const Types::TPoint ptTest, Word &pwHitTestCode);
...
extern PACKAGE HRESULT __stdcall (*DrawThemeIcon)(unsigned hTheme, HDC hdc, int iPartId, int iStateId, const Types::TRect &pRect, unsigned himl, int iImageIndex);
...
extern PACKAGE HRESULT __stdcall (*GetThemeBool)(unsigned hTheme, int iPartId, int iStateId, int iPropId, BOOL &pfVal);
extern PACKAGE HRESULT __stdcall (*GetThemeInt)(unsigned hTheme, int iPartId, int iStateId, int iPropId, int &piVal);
extern PACKAGE HRESULT __stdcall (*GetThemeEnumValue)(unsigned hTheme, int iPartId, int iStateId, int iPropId, int &piVal);
extern PACKAGE HRESULT __stdcall (*GetThemePosition)(unsigned hTheme, int iPartId, int iStateId, int iPropId, Types::TPoint &pPoint);
extern PACKAGE HRESULT __stdcall (*GetThemeFont)(unsigned hTheme, HDC hdc, int iPartId, int iStateId, int iPropId, tagLOGFONTA &pFont);
extern PACKAGE HRESULT __stdcall (*GetThemeRect)(unsigned hTheme, int iPartId, int iStateId, int iPropId, Types::TRect &pRect);
...
extern PACKAGE HRESULT __stdcall (*GetThemeIntList)(unsigned hTheme, int iPartId, int iStateId, int iPropId, _INTLIST &pIntList);
extern PACKAGE HRESULT __stdcall (*GetThemePropertyOrigin)(unsigned hTheme, int iPartId, int iStateId, int iPropId, PROPERTYORIGIN &pOrigin);
...
extern PACKAGE HRESULT __stdcall (*GetThemeSysFont)(unsigned hTheme, int iFontId, tagLOGFONTA &plf);
...
extern PACKAGE HRESULT __stdcall (*GetThemeSysInt)(unsigned hTheme, int iIntId, int &piValue);
...
extern PACKAGE HRESULT __stdcall (*DrawThemeParentBackground)(HWND hwnd, HDC hdc, Types::PRect prc);
extern PACKAGE HRESULT __stdcall (*EnableTheming)(BOOL fEnable);
extern PACKAGE bool __fastcall InitXPThemes(void);
extern PACKAGE void __fastcall FreeXPThemes(void);
extern PACKAGE bool __fastcall CanUseXPThemes(void);

}	/* namespace Tbxuxthemes */
using namespace Tbxuxthemes;
#pragma option pop	// -w-
